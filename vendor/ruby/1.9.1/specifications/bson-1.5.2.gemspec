...
Gem::Specification.new do |s|
  ...
  s.files = ["test/bson/binary_test.rb", "test/bson/json_test.rb", "test/bson/byte_buffer_test.rb", "test/bson/ordered_hash_test.rb", "test/bson/object_id_test.rb", "test/bson/test_helper.rb", "test/bson/bson_test.rb", "test/bson/timestamp_test.rb", "test/bson/hash_with_indifferent_access_test.rb", "test/support/hash_with_indifferent_access.rb", "bin/b2json", "bin/j2bson"]
  s.homepage = %q{http://www.mongodb.org}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.6.2}
  s.summary = %q{Ruby implementation of BSON}
  s.test_files = ["test/bson/binary_test.rb", "test/bson/json_test.rb", "test/bson/byte_buffer_test.rb", "test/bson/ordered_hash_test.rb", "test/bson/object_id_test.rb", "test/bson/test_helper.rb", "test/bson/bson_test.rb", "test/bson/timestamp_test.rb", "test/bson/hash_with_indifferent_access_test.rb", "test/support/hash_with_indifferent_access.rb"]
